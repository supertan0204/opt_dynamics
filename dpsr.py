# Codes below are copied from https://github.com/autonomousvision/shape_as_points
import torch
import torch.nn as nn
from mesh_utils import spec_gaussian_filter, fftfreqs, img, grid_interp, point_rasterize
import numpy as np
import torch.fft

class DPSR(nn.Module):
    def __init__(self, res, sig=1, scale=True, shift=True):
        """
